...
SECRET_KEY = 'django-insecure-27if_ody%6vqn&8b&(3nu9ni_rd)=teh-fvie3xrfq%wdcj=4y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'fierce-ocean-36761.herokuapp.com']
